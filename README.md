...
1. [Introduction](#1-introduction)
   - [Welcome to the Git & GitHub Handbook](#welcome-to-the-git--github-handbook-)

2. [What is Git?](#2-what-is-git)
   - [A Commit Timeline](#-a-commit-timeline)
   - [Use Git When You Want](#-use-git-when-you-want)
   - [Visualizing a Simple Git Workflow](#-visualizing-a-simple-git-workflow)
...
3. [Understanding Version Control Systems](#3-understanding-version-control-systems)
   ...
   - [Why Git Uses a Distributed Model](#-why-git-uses-a-distributed-model)
   - [In Short](#-in-short)
...
4. [Git vs GitHub](#4-git-vs-github)
   ...
   - [In Short](#-in-short-1)
   - [Git vs GitHub Comparison](#git-vs-github-comparison)

5. [Installing Git](#5-installing-git)
   - [Installing Git on Windows](#-installing-git-on-windows)
     - [Method 1: Download from the Official Website](#method-1-download-from-the-official-website-recommended)
     - [Method 2: Install Using Winget](#method-2-install-using-winget)
   - [Installing Git on macOS](#-installing-git-on-macos)
     - [Method 1: Install Xcode Command Line Tools](#method-1-install-xcode-command-line-tools-recommended)
     - [Method 2: Install Using Homebrew](#method-2-install-using-homebrew)
   - [Installing Git on Linux](#-installing-git-on-linux)
     - [Debian / Ubuntu](#debian--ubuntu)
     - [Fedora](#fedora)
     - [Arch Linux](#arch-linux)
   - [Verify the Installation](#-verify-the-installation)
   - [Choosing Your Git Workflow](#-choosing-your-git-workflow)
   - [Quick Installation Summary](#-quick-installation-summary)

6. [How Git Works](#6-how-git-works)
   - [The Four Areas of Git](#the-four-areas-of-git)
   - [The Git Workflow](#the-git-workflow)
   - [Understanding Snapshots](#understanding-snapshots)

7. [Hands-on Git](#7-hands-on-git)
   - [Basic Git Checks](#basic-git-checks)
   - [Set Your Git Identity](#set-your-git-identity)
   - [The Big Four Git Commands](#-the-big-four-git-commands)
   - [1. git status](#1-git-status)
   - [2. git add](#2-git-add)
     - [Stage one file](#stage-one-file)
     - [Stage multiple files](#stage-multiple-files)
     - [Stage all changes](#stage-all-changes)
     - [Stage all files of one type](#stage-all-files-of-one-type)
   - [3. git commit](#3-git-commit)
   - [4. git log](#4-git-log)
     - [Full commit history](#full-commit-history)
     - [Compact one-line history](#compact-one-line-history)
     - [Show the last 5 commits](#show-the-last-5-commits)
     - [Display branch and merge history as a graph](#display-branch-and-merge-history-as-a-graph)
   - [The Basic Git Lifecycle](#the-basic-git-lifecycle)
   - [More Useful Everyday Commands](#more-useful-everyday-commands)
     - [Unstage a file](#unstage-a-file)
     - [Stage everything](#stage-everything)
     - [View compact history](#view-compact-history)
     - [View graphical history](#view-graphical-history)
   - [Command Reference at a Glance](#command-reference-at-a-glance)

8. [Git Scenario 1: Single User Setup](#8-git-scenario-1-single-user-setup)
   - [Complete Walkthrough](#complete-walkthrough)
   - [Viewing History](#viewing-history)
   - [Best Practices While Committing](#best-practices-while-committing)
   - [The Full Workflow in One View](#the-full-workflow-in-one-view)

9. [Ignoring Files](#9-ignoring-files)
   - [Why Some Files Should Not Be Tracked](#why-some-files-should-not-be-tracked)
   - [Understanding .gitignore](#understanding-gitignore)
   - [Common .gitignore Rules](#common-gitignore-rules)
   - [Pattern Reference](#pattern-reference)
   - [Empty Folders and .gitkeep](#empty-folders-and-gitkeep)
   - [Already Tracking a File?](#already-tracking-a-file)

10. [Tracking Empty Directories](#10-tracking-empty-directories)

11. [Branches](#11-branches)
    - [What is a Branch?](#what-is-a-branch)
    - [Why Branches Exist](#why-branches-exist)
    - [Creating a Branch](#creating-a-branch)
    - [Switching Branches](#switching-branches)
    - [Creating and Switching Together](#creating-and-switching-together)
    - [Viewing Branches](#viewing-branches)
    - [Understanding the Git Graph](#understanding-the-git-graph)
...
12. [Merge Conflict](#12-merge-conflict)
    ...
    - [Understanding git diff](#understanding-git-diff)
      - [View Unstaged Changes](#view-unstaged-changes)
      - [View Staged Changes](#view-staged-changes)
      - [View Changes in a Specific File](#view-changes-in-a-specific-file)
    - [Quick git diff Reference](#quick-git-diff-reference)
    - [Best Practices to Avoid Conflicts](#best-practices-to-avoid-conflicts)
    - [Abort a Merge if You Are Stuck](#abort-a-merge-if-you-are-stuck)

13. [Stashing in Git](#13-stashing-in-git)
    - [Why Git Stash Exists](#why-git-stash-exists)
    - [Saving Work Temporarily](#saving-work-temporarily)
    - [Viewing Stashes](#viewing-stashes)
    - [Restoring a Stash](#restoring-a-stash)
    - [Applying vs Popping](#applying-vs-popping)
    - [Real-World Example](#real-world-example)
    - [Deleting a Stash](#deleting-a-stash)
    - [Clearing All Stashes](#clearing-all-stashes)
    - [Quick Command Reference](#quick-command-reference)

14. [Git Tags](#14-git-tags)
    - [Why Tags Exist](#why-tags-exist)
...
15. [Git Rebase](#15-git-rebase)
    ...
    - [Rebasing Before a Pull Request](#rebasing-before-a-pull-request)
...
16. [Using GitHub to Host Our Repositories](#16-using-github-to-host-our-repositories)
    ...
    - [Understanding README.md](#understanding-readmemd)
    - [Cloning a Public Repository](#cloning-a-public-repository)
    - [Clone a Repository from GitHub Using Git Bash](#clone-a-repository-from-github-using-git-bash)
    - [Cloning a Private Repository Using an SSH Key](#cloning-a-private-repository-using-an-ssh-key)
      - [Step 1: Check for an Existing SSH Key](#step-1-check-for-an-existing-ssh-key)
      - [Step 2: Generate a New SSH Key](#step-2-generate-a-new-ssh-key)
      - [Step 3: Add the Key to the SSH Agent](#step-3-add-the-key-to-the-ssh-agent)
      - [Step 4: Copy Your Public SSH Key](#step-4-copy-your-public-ssh-key)
      - [Step 5: Add the SSH Key to GitHub](#step-5-add-the-ssh-key-to-github)
      - [Step 6: Test the SSH Connection](#step-6-test-the-ssh-connection)
      - [Step 7: Clone the Private Repository with SSH](#step-7-clone-the-private-repository-with-ssh)
    - [Connecting an Existing Local Repository to GitHub](#connecting-an-existing-local-repository-to-github)
    - [Viewing Connected Remote Repositories](#viewing-connected-remote-repositories)
    - [Understanding origin](#understanding-origin)
    - [Understanding main](#understanding-main)
    - [Rename Your Current Branch](#rename-your-current-branch)
    - [Make main the Default Branch for New Local Repositories](#make-main-the-default-branch-for-new-local-repositories)
    ...
    - [Complete GitHub Hosting Workflow](#complete-github-hosting-workflow)
...
17. [GitHub Desktop: GUI for Git and GitHub](#17-github-desktop-gui-for-git-and-github)
    ...
    - [Sign In to GitHub Desktop](#sign-in-to-github-desktop)
    - [Create a Repository in GitHub Desktop](#create-a-repository-in-github-desktop)
    - [Publish Your Repository on GitHub](#publish-your-repository-on-github)
    - [Public vs Private Repositories](#public-vs-private-repositories)
    - [Make Changes and Commit Using GitHub Desktop](#make-changes-and-commit-using-github-desktop)
    - [Creating a Branch in GitHub Desktop](#creating-a-branch-in-github-desktop)
    - [Publish a Branch to GitHub](#publish-a-branch-to-github)
    - [Understanding Pull Requests](#understanding-pull-requests)
    - [Create a Pull Request Using GitHub Desktop](#create-a-pull-request-using-github-desktop)
    - [Review and Merge a Pull Request on GitHub](#review-and-merge-a-pull-request-on-github)
    - [What is Forking?](#what-is-forking)
    - [Create a Fork on GitHub](#create-a-fork-on-github)
    - [Clone Your Fork Using GitHub Desktop](#clone-your-fork-using-github-desktop)
    - [Contribute Back Through a Fork](#contribute-back-through-a-fork)
    - [Do Not Open Pull Requests Blindly](#do-not-open-pull-requests-blindly)
    - [Understanding GitHub Stars](#understanding-github-stars)
    - [Practice Workflow with a Friend](#practice-workflow-with-a-friend)
    - [GitHub Desktop Workflow at a Glance](#github-desktop-workflow-at-a-glance)
...
18. [Using Git in VS Code](#18-using-git-in-vs-code)
    ...
    - [Viewing File Differences](#viewing-file-differences)
    - [Timeline View](#timeline-view)
    - [Managing Branches](#managing-branches)
      - [Create a New Branch](#create-a-new-branch)
      - [Switch to Another Branch](#switch-to-another-branch)
    - [Merge Conflict Resolution](#merge-conflict-resolution)
    - [Publishing a Repository to GitHub](#publishing-a-repository-to-github)
    - [Git Graph Extension](#git-graph-extension)
    - [VS Code Git Workflow at a Glance](#vs-code-git-workflow-at-a-glance)
...
19. [Git Scenario 2: Multi-User Setup](#19-git-scenario-2-multi-user-setup)
    ...
    - [Issues Work Like a Discussion](#issues-work-like-a-discussion)

20. [Modern Workflow](#20-modern-workflow)
    - [Using Git While Vibe Coding](#using-git-while-vibe-coding)
    - [Reviewing AI-Generated Code](#reviewing-ai-generated-code)
    - [AI-Generated Commit Messages](#ai-generated-commit-messages)
    - [Daily Git Workflow](#daily-git-workflow)
    - [Quick Reference](#quick-reference-1)

21. [Conclusion](#21-conclusion)
    - [Git Best Practices](#-git-best-practices)
      - [Core Commit Habits](#core-commit-habits)
      - [One Feature Per Branch](#one-feature-per-branch)
      - [Pull Before Push](#pull-before-push)
      - [Never Commit Secrets](#never-commit-secrets)
      - [Use .gitignore](#use-gitignore)
      - [Review Before Every Commit](#review-before-every-commit)
      - [Quick Reference](#quick-reference-2)
    - [Git Cheat Sheet](#-git-cheat-sheet)
      - [Repository Commands](#repository-commands)
      - [Tracking & Commit Commands](#tracking--commit-commands)
      - [Branch Commands](#branch-commands)
      - [Remote Commands](#remote-commands)
      - [History & Review Commands](#history--review-commands)
      - [Undo & Stash Commands](#undo--stash-commands)
      - [Quick Workflow](#quick-workflow)
    - [You Now Have a Solid Foundation](#you-now-have-a-solid-foundation-)
